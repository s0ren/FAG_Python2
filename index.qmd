...
-   Virtuelt Envirenment til Python, med git integration
...
-   CRUD til realationsdatabaser.
    -   ORM med SQLAlncemy
-   Little Big Data
    -   Nestede data (i JSON eller XML)
    -   kolonne baserede lagerformater

## Opsætning af virtuelt miljø til dit Python projekt

### og isoler fra git-reposity

<!-- TODO vejledning og øvelser til `venv` og .gitignore 
-->
...
<!-- TODO Tilføj intro til SQLAlchemy -->
