...
Sørens ufærdige løsning: <`C:\Users\smag\Docs\foolaround\Vind_El_Explor\dataset.ipynb`>

Analysen mangler især at kigge korrelationskoeficienter over varierede tidsintervaller, og det samme for forskellige vindhastigheder, også over tid.

<!--
FIXME Den "vejledende-løsning" mangler at finde svar. Derfor er vejledningen i retning, fremgangsmåde og teknikker lidt usikker.
TODO Koorelationsanlyse, 
TODO histogram på vind og el
-->
